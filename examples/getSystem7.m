function [A, B, C, F2, f, g, h] = getSystem7()
%getSystem7  Generates an aircraft stall model for testing stabilization.
%
%   Recommended Usage:  [~,~,~,~,f,g,h] = getSystem7()
%
...
% \dot{x}_1 & =  + 0.28 u x_1^2  \\
% \dot{x}_3 & =  + 6.265 u x_1^2 
%   
